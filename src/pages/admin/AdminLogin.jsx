            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className="block w-full px-3 py-2 pr-16 border border-gray-600 text-white bg-gray-700 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                  placeholder="Password"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword((prev) => !prev)}
                  className="absolute inset-y-0 right-0 px-3 text-sm font-medium text-indigo-300 hover:text-indigo-200"
                >
